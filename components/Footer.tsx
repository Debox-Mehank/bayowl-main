  ...
  return (
    <div className="bg-black text-white relative">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2  lg:grid-cols-4 xl:grid-cols-4 items-start">
          <div className="p-2 text-center flex flex-col gap-8 justify-center items-center self-center">
            <svg
              ...
              className="fill-white hover:fill-primary cursor-pointer transition-colors duration-300"
              height={150}
              width={150}
            >
            ...
            <div className="flex items-center justify-center gap-4 mt-4 lg:justify-start xl:justify-start">
              <a
                target="_blank"
                rel="noreferrer"
                href={"https://www.instagram.com/bayowlstudios/"}
              >
                <FontAwesomeIcon
                  icon={faInstagram}
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href={"https://www.facebook.com/bayowlstudios"}
              >
                <FontAwesomeIcon
                  icon={faFacebookF}
                  className="text-white hover:text-primary h-5 w-5 cursor-pointer transition-colors duration-300"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href={"https://twitter.com/bayowlstudios"}
              >
                <FontAwesomeIcon
                  icon={faTwitter}
                  className="text-white hover:text-primary h-5 w-5 cursor-pointer transition-colors duration-300"
          ...
          <div className="p-2 flex flex-col justify-center items-center lg:items-start xl:items-start">
            <div>
              ...
              <ul className="space-y-4 text-center lg:text-left">
                <li className="hover:text-primary duration-300 transition-colors">
                  <Link href={"/studio-services"}>Studio Services</Link>
                </li>
                <li className="hover:text-primary duration-300 transition-colors">
          ...
          <div className="p-2 flex flex-col justify-center items-center lg:items-start xl:items-start space-y-5">
            <h4 className="text-xl text-primary font-bold">Contact Info</h4>
            <div className="flex flex-col justify-center items-center lg:items-start xl:items-start space-y-5">
              <h4 className="font-normal text-lg">Address</h4>
              <p className="font-light text-white text-sm whitespace-pre-wrap text-center lg:text-left">
                {
                  "601 Multilink House, 3rd Road, \nKhar West, Mumbai, \nMaharashtra, India"
                }
              </p>
              <h4 className="font-normal text-lg">Phone</h4>
              <p className="font-light text-white text-sm whitespace-pre-wrap">
                <a href="tel:+918691972282">+91 86919 72282</a>
              </p>
              <h4 className="font-normal text-lg">E-Mail</h4>
              <a href="mailto:manager@bayowlstudios.com">
                manager@bayowlstudios.com
              </a>
            </div>
            <div></div>
          </div>
          <div className="p-2 flex flex-col justify-center items-center lg:items-start xl:items-start space-y-5">
            <h4 className="font-bold text-xl text-primary">Locate Us</h4>
            <p className="font-light text-white text-sm whitespace-pre-wrap">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1885.4233911050082!2d72.839693!3d19.070473!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x62bd844b9af66222!2sBay%20Owl%20Studios!5e0!3m2!1sen!2sus!4v1658942197222!5m2!1sen!2sus"
                className="h-64 w-full filter border-0 invert-[0.9] rounded-2xl"
                loading="lazy"
      ...
      <div className="flex flex-col items-center md:flex-row justify-around text-sm py-4 text-white w-11/12 mx-auto text-center">
        <p>
          {" "}
          <span className="text-primary">Bay Owl Studios</span> | © All rights
          reserved 2022
        </p>
        <p>
