...
const Essentials = () => {
    ...
    return (
        <section id="gear" className="bg-darkBlue text-white py-10 pb-20">
            <div
                className="max-w-7xl mx-auto w-11/12 flex justify-center items-center flex-col gap-8 select-none relative"
            >
                <Heading title="Gear" />
                ...
                <div ref={horizontalScrollDiv} className="flex flex-row gap-1 md:gap-6 md:justify-center md:items-center xl:px-16 lg:px-8 z-10 whitespace-nowrap overflow-x-auto w-screen md:w-auto pb-5 px-2 scrollbar-hide">
                                        ...
                                        >
                                            ...
                                            {essential.body.map((gearSubCategory, idx) => (
                                                <div className="w-full" key={gearSubCategory.subCat}>
                                                    <h1 className="text-left font-bold text-xl text-transparent bg-clip-text bg-gradient-to-br from-orange1 via-orange2 to-orange3">{gearSubCategory.subCat}</h1>
                                                    <ul className="text-left items-center justify-center grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 py-4">
                                                        {gearSubCategory.list.map(gearItem => (
                                                            <li key={gearItem} className="flex items-start gap-2">
                                                                <span className="md:w-1/12">
                                                                    <svg className="inline fill-primary" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
