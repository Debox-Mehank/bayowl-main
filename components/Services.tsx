            ...
            <div className='max-w-7xl w-11/12 mx-auto py-10  relative'>
                ...
                <div className='flex flex-wrap justify-center gap-10 py-10 opacity-1'>
                    {serviceList.map((service, idx) => (
                        <div key={service.title} className="max-w-sm  transition-all duration-300 hover:scale-105 hover:shadow-2xl backdrop-blur-3xl bg-white/5 rounded-lg shadow-xl outline-8 outline-white">
                            <Link href={service.route}>
                                <div className='hidden md:block max-h-60 overflow-clip'>
                                    <Image objectFit='contain' className='h-20 cursor-pointer rounded-t-lg' src={service.img} />
                                </div>
                            </Link>
                            <div className="p-5">
                                <Link href={service.route}>
