        ...
        content() {
            return (
                <ul className='list-disc space-y-2 pl-10'>
                    ...
                    <li>{"Request a <spe></spe>cific instrument class."}</li>
            ...
            <div className="relative pb-32 overflow-hidden space-y-10">
                ...
                <div className='py-10'>
                    <div className='mx-auto text-center'>
                        ...
                        <p className='text-xl py-4'>Bay Owl Studios is your one stop shop for anything audio!</p>
                    </div>
                </div>
                                ...
                                <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24 place-items-center">
                                    <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                                        <div>
                                            ...
                                            <div className="mt-6">
                                                <h2 tabIndex={0} className="text-3xl font-extrabold tracking-tight text-primary">
                                                    {service.title}
                                                </h2>
                                    ...
                                    <div className="mt-12 sm:mt-16 lg:mt-0">
                                        <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                                            ...
                                            /> */}
                                            <Image className='w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none' src={service.img} />
                                        </div>
                                    </div>
                                </div>
                            </div>
