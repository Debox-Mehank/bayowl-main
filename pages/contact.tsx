            ...
            <div className='grid place-items-center gap-4 text-center items-start grid-cols-1 md:grid-cols-3 max-w-7xl mx-auto'>
                <div className='flex flex-col gap-4 py-10 align-top'>
                    <a href="https://g.page/bayowlstudios">
                        <svg className='fill-primary block mx-auto' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className='flex flex-col gap-4 py-10 align-top'>
                    ...
                    <div className=''>
                        <h4 className=''>{"Office Hours : Monday to Saturday | 10 am – 7 pm"}</h4>
                ...
                <div className='flex flex-col gap-4 py-10 align-top'>
                    ...
                    <div>
                        <a className='block' href="mailto:manager@bayowlstudios.com">
                            {"Email: manager@bayowlstudios.com"}</a>
                ...
                <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5 items-center">
                    ...
                    <div className="py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
                        <div className="max-w-lg mx-auto space-y-4">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7541.693154882908!2d72.839609!3d19.070482!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x62bd844b9af66222!2sBay%20Owl%20Studios!5e0!3m2!1sen!2sus!4v1659125806069!5m2!1sen!2sus" className='w-[28rem] filter border-0 invert-[0.9] max-w-full rounded-2xl shadow-2xl shadow-white' height="400" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                    <div className="py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
                        <div className="max-w-lg mx-auto lg:max-w-none">
                            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl text-transparent bg-clip-text bg-gradient-to-br from-orange1 to-orange3 mb-4">Leave us a message.</h2>
                            <form action="#" method="POST" className="grid grid-cols-1 gap-y-6 text-">
                                <div>
                                ...
                                <div>
                                    <button onClick={() => console.log(contactFormData)}
                                        type="submit"
